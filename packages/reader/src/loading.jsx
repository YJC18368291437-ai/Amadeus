...
export function PreviewLoading({ phase, value, maximum, loaded = 0, total = 0 }) {
  ...
  return <div className="amadeus-preview-loading" role="progressbar" aria-label={label} aria-valuemin={0} aria-valuemax={100} aria-valuenow={percent} data-indeterminate={percent === undefined ? '' : undefined}>
